 ...
 */
public class cicloLavadoAlgodon implements mediadorLavadora{
    private boton boton;
    ...
    public cicloLavadoAlgodon(boton boton, calentador calentador, motor motor, tambor tambor, valvula valvula, sensor sensor) {
        this.boton = boton;
    ...
    public void iniciarCiclo() {
        System.out.println("Iniciando ciclo de lavado ropa de algodon ");
