 ...
 */
public class cicloLavadoSeda implements mediadorLavadora{
    private boton boton;
    ...
    public cicloLavadoSeda(boton boton, calentador calentador, motor motor, tambor tambor, valvula valvula, sensor sensor) {
        this.boton = boton;
    ...
    public void iniciarCiclo() {
        System.out.println("Iniciando ciclo de lavado ropa de seda ");
